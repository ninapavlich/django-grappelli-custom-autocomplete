...
(function($){
    ...
    var methods = {
        init: function(options) {
            options = $.extend({}, $.fn.grp_custom_autocomplete_m2m.defaults, options);
            return this.each(function() {
                ...
                }, $.fn.grp_custom_autocomplete_m2m.defaults, options);
    ...
    $.fn.grp_custom_autocomplete_m2m = function(method) {
        if (methods[method]) {
            return methods[method].apply(this, Array.prototype.slice.call(arguments, 1));
        } else if (typeof method === 'object' || ! method) {
            return methods.init.apply(this, arguments);
        } else {
            $.error('Method ' +  method + ' does not exist on jQuery.grp_custom_autocomplete_m2m');
        }
        return false;
    };
