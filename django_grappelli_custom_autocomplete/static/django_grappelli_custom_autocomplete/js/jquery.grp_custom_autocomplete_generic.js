...
(function($){
    ...
    var methods = {
        init: function(options) {
            options = $.extend({}, $.fn.grp_custom_autocomplete_generic.defaults, options);
            return this.each(function() {
                ...
                }, $.fn.grp_custom_autocomplete_generic.defaults, options);
                // lookup
                if (val) {
    ...
    $.fn.grp_custom_autocomplete_generic = function(method) {
        if (methods[method]) {
            return methods[method].apply(this, Array.prototype.slice.call(arguments, 1));
        } else if (typeof method === 'object' || ! method) {
            return methods.init.apply(this, arguments);
        } else {
            $.error('Method ' +  method + ' does not exist on jQuery.grp_custom_autocomplete_generic');
        }
        return false;
    };
            ...
            .data("ui-autocomplete")._renderItem = function(ul,item) {
                if (!item.value) {
                    return $("<li></li>")
                        ...
                        .append( "<span class='error'>" + item.dropdown_label + "</span>")
                        .appendTo(ul);
                } else {
                    return $("<li></li>")
                        .data( "item.autocomplete", item )
                        .append( "<a>" + item.dropdown_label + "</a>")
                        .appendTo(ul);
                }
            };
    };
    ...
    $.fn.grp_custom_autocomplete_generic.defaults = {
