...
(function($){
    ...
    var methods = {
        init: function(options) {
            ...
            return this.each(function() {
                ...
                }, $.fn.grp_custom_autocomplete_fk.defaults, options);
                // lookup
    ...
    $.fn.grp_custom_autocomplete_fk = function(method) {
        ...
        if (methods[method]) {
            ...
            $.error('Method ' +  method + ' does not exist on jQuery.grp_custom_autocomplete_fk');
        }
        return false;
    };
    ...
    $.fn.grp_custom_autocomplete_fk.defaults = {
